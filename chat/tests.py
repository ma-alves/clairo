...
class ChatTestCase(TestCase):
    ...
    def setUpTestData(cls):
        cls.user1 = User.objects.create_user(username="usuario_de_teste1", password="Senha1234!")
        cls.user2 = User.objects.create_user(username="usuario_de_teste2", password="Senha1234!")
